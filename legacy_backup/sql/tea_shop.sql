-- InfinityFree compatible - remove CREATE DATABASE and USE statements
...
INSERT INTO users (username, password, full_name, email, email_verified_at, role)
VALUES (
  'admin',
...
-- SNACKS
('TAKOYAKI', 'Snacks - Takoyaki', 59.00, 30),
