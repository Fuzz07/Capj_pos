...
<head>
  ...
  <title>Receipt #<?= e($orderId) ?> - Captain J</title>
...
<div class="container py-4">
  <div class="receipt">
    ...
    <h5> <img src="<?= BASE_PATH ?>/images/capj.jpg" alt="Captain J" style="float: center; width: 20%; border-radius: 200px 200px 200px 200px; border: 3px solid #fff; margin-bottom: 15px;"> Captain J</h5>
    <hr>

  
    <div><strong>Customer:</strong> <?= e($order['customer_name']) ?></div>
    <div><strong>Order Type:</strong> <?= e($order['order_type'] ?? 'Dine-in') ?></div>
    <div><strong>Payment:</strong> <?= e($order['payment_method'] ?? 'Cash') ?></div>
    ...
    <table class="table table-sm">
      ...
      <tbody>
        ...
        <?php if ($isTakeout && $totalTakeoutBoxes > 0): ?>
          <?php $takeoutBoxes = (int)ceil($totalTakeoutBoxes / 2); ?>
          <?php $takeoutCost = $takeoutBoxes * $takeoutFeePerBox; ?>
          <tr>
            <td><em>Take-Out Box</em></td>
            <td class="text-center"><?= e($takeoutBoxes) ?></td>
